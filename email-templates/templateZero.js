const templateZero = (userEmail, contactEmail, contactName, contactSummary) => {
    ...
    <p>Here's what you said it's important to know about them, or what you discussed recently: <br/> ${contactSummary}. <br/> <br/> If you want to update what you talked about, you can <a href="#">do that here</a>.</p>`;
    return text;
}
